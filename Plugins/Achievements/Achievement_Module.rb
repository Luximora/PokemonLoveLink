...
module Achievements
  ...
  @achievementList={
    ...
    "SWEETTALKER"=>{
      "id"=>14,
      "name"=>"Sweet Talker",
      "description"=>"read a LI's mood and say the perfect thing.",
      "goals"=>[30,90,180]
    },
    "LRIZZ"=>{
      "id"=>19,
      "name"=>"L Rizz",
      "description"=>"read a LI's mood and say the worst thing.",
      "goals"=>[20,60,120]
    },
    "BREAKINGICE"=>{
      "id"=>15,
      "name"=>"Breaking the Ice",
      "description"=>"Unlock intro scenes with different characters.",
      "goals"=>[1,3,5]
    },
    "HEARTHUSTLER"=>{
      "id"=>16,
      "name"=>"Heartthrob Hustler",
      "description"=>"Start a relationships with multiple characters.",
      "goals"=>[2,3,5]
    },
    "TOKENAFFECTION"=>{
      "id"=>17,
      "name"=>"Token of Affection",
      "description"=>"Give gifts to love intrests.",
      "goals"=>[30,90,180]
    },
    "PRESENTPERFECTION"=>{
      "id"=>18,
      "name"=>"Present Perfectionist",
      "description"=>"Give the perfect gifts to love intrests.",
      "goals"=>[20,60,120]
    },
    "NAUGHTYNAVIGATOR"=>{
      "id"=>19,
      "name"=>"Naughty Navigator",
      "description"=>"Discover sex scenes.",
      "goals"=>[1,3,5]
    }
  }
  def self.list
