module Settings
    ...
    #====================================================================================
        ...
        TIP_CARDS_CONFIGURATION = {
            ...
            :REUSEITEMS => {
                :Title => _INTL("Reusable Items"),
                :Text => _INTL("Unlike actual pokemon games, held items like berries, focus sashes, air baloons etc. are reused after being consumed in battle after the battle finishes!"),
                :Image => "reusableItems",
                :Background => "bg2"
            },
            :QUESTS => {
                :Title => _INTL("Quests"),
                :Text => _INTL("People who has something to ask you will have a <c2=0999367C><b>quest icon</b></c2> displayed above them. If you complete their quest you may get a nice reward."),
                :Image => "quest",
                :Background => "bg2"
            },
            :TALKS => {
                :Title => _INTL("Speaking/Moods"),
                :Text => _INTL("Pressing the say <c2=0999367C><b>say</b></c2> option when talking to a love intrest will give you 3 random options of something to say, how well those options are recieved by said intrest will depend on their mood."),
                :Image => "quest",
                :Background => "bg2"
            },
            :CATCH => {
