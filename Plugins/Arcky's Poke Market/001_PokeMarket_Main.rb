...
def pbShelfMart(stockWithLimit, speech: nil, useCat: false, discount: nil, currency: "money")
  ...
  echoln($ArckyGlobal.pokeMartTracker[@map_id][@event_id])
  ...
  # Remove the getSpeech and pbMessage calls
  scene = PokemonMart_Scene.new
  # Pass an empty hash for getSpeech to skip dialogue
  screen = PokemonMartScreen.new(scene, stock, {}, nil, nil, pokeMartTracker, discount)
